...
mod test {
    ...
    async fn list() -> ApiResult<()> {
        ...
        verify_request(&format!("{QUERY}={SORT}{FIELDS}"), "pool/list.json").await?;
        verify_request(&format!("{QUERY}=sort:post-count&limit=1{FIELDS}"), "pool/list_most_posts.json").await?;
        verify_request(&format!("{QUERY}=category:Setting {SORT}{FIELDS}"), "pool/list_category_setting.json").await?;
        verify_request(&format!("{QUERY}=name:*punk* {SORT}{FIELDS}"), "pool/list_name_punk.json").await
    }
    ...
    async fn get() -> ApiResult<()> {
        ...
        verify_request(&format!("GET /pool/{POOL_ID}/?{FIELDS}"), "pool/get.json").await?;
    ...
    async fn create() -> ApiResult<()> {
        ...
        verify_request(&format!("POST /pool/?{FIELDS}"), "pool/create.json").await?;
        ...
        verify_request(&format!("DELETE /pool/{pool_id}/?{FIELDS}"), "pool/delete.json").await?;
    ...
    async fn merge() -> ApiResult<()> {
        ...
        verify_request(&format!("POST /pool-merge/?{FIELDS}"), "pool/merge.json").await?;
    ...
    async fn update() -> ApiResult<()> {
        ...
        verify_request(&format!("PUT /pool/{POOL_ID}/?{FIELDS}"), "pool/update.json").await?;
        ...
        verify_request(&format!("PUT /pool/{POOL_ID}/?{FIELDS}"), "pool/update_restore.json").await?;
