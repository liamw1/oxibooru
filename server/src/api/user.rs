...
mod test {
    ...
    async fn list() -> ApiResult<()> {
        ...
        verify_request(&format!("{QUERY}={SORT}{FIELDS}"), "user/list.json").await?;
        verify_request(&format!("{QUERY}=name:*user* {SORT}{FIELDS}"), "user/list_has_user_in_name.json").await
    }
    ...
    async fn get() -> ApiResult<()> {
        ...
        verify_request(&format!("GET /user/{NAME}/?{FIELDS}"), "user/get.json").await?;
    ...
    async fn create() -> ApiResult<()> {
        ...
        verify_request(&format!("POST /users/?{FIELDS}"), "user/create.json").await?;
        ...
        verify_request(&format!("DELETE /user/{name}"), "user/delete.json").await?;
    ...
    async fn update() -> ApiResult<()> {
        ...
        verify_request(&format!("PUT /user/{NAME}/?{FIELDS}"), "user/update.json").await?;
        ...
        verify_request(&format!("PUT /user/{new_name}/?{FIELDS}"), "user/update_restore.json").await?;
